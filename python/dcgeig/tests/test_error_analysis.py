...
class Test_compute_backward_error_finite(unittest.TestCase):
    def test_simple(self):
        ...
        eta = EA.compute_backward_error_finite(I, I, d, I)
    ...
    def test_infinite(self):
        ...
        with self.assertRaises(ValueError):
            eta = EA.compute_backward_error_finite(I, I, d, x)
    ...
    def test_precondition_checks(self):
        ...
        with self.assertRaises(ValueError):
            eta = EA.compute_backward_error_finite(I+1j, I, d, X)

        with self.assertRaises(ValueError):
            eta = EA.compute_backward_error_finite(I, I, d+1j, X)
    ...
    def test_nullspace_intersection(self):
        ...
        with self.assertRaises(ValueError):
            eta = EA.compute_backward_error_finite(A, B, d, X)
...
class TestBackwardError(unittest.TestCase):
    def test_simple(self):
        n = 2;
